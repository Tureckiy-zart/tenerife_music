...
export default function PageHeader({ icon, title, description, className = '' }: PageHeaderProps) {
  return (
    <section className={`relative bg-gradient-to-br from-[#003A4D] via-[#004A5D] to-[#00A6A6] text-white overflow-hidden h-[60vh] min-h-[500px] flex items-center ${className}`}>
      {/* Decorative Elements */}
