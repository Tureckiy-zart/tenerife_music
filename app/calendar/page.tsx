  ...
  return (
    <>
      ...
      <PageHeader
        ...
        description="Plan your musical journey across Tenerife. Discover events, festivals, and concerts happening throughout the month with our comprehensive calendar view."
      />
