  ...
  return (
    <>
      ...
      <PageHeader
        ...
        description="Discover Tenerife's diverse music scenes across different areas. From the bustling capital to serene mountain towns, each area offers its own unique musical character."
      />
